...
/***************************************************************************
    ...
    Default factory state (no command-line argument): PIO-A has the
    keyboard slot card; PIO-B is empty.  The CP/NET fast-link bridge
    lives in this directory as another card option, selected via
    `-piob cpnet_bridge:<host_args>` when CP/NET is wanted.

    See rc700-gensmedet/docs/cpnet_fast_link.md for the design context.
